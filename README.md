...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colcon-powershell-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8114&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-powershell-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-powershell` can be installed with:

```
conda install colcon-powershell
```

It is possible to list all of the versions of `colcon-powershell` available on your platform with:
